	...
	public static void main(String[] args) {
		...
		while (MenuNo != 99) {
			...
			case 4:
				...
				// 1. word.length()--총길이 / 2 -- 나누기2 하면 가운데.
				// 2. Math.round() -- 반올림.  (Math.round(word.length()/2)) --> 단어의 한 가운데의 인덱스
				// 3. word.substring(단어의 한 가운데의 인덱스) -> 단어의 가운데부터 끝까지
				
//				System.out.println("자르고 싶은 범위를 입력하세요.");
//				System.out.println("자르고 싶은 위치를 입력하세요.");
